...
if page == "Homepage":
    ...
    st.image("https://www.wispro.com/wp-content/uploads/2022/11/221107-Abstract-AI-lamp-on-starry-sky-background.-Artificial-intelligence-and-science-concept.-3D-Rendering.jpg", caption="Your Amazing Banner Image", use_column_width=True)
    st.write("""
    Hi! I'm [kaijeow], a passionate [Your Profession] with expertise in [Your Skills or Specializations].
